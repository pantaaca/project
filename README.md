...
**Linear Power Supply (0-25V, 0-3A)** - This project demonstrates the design and implementation of a linear adjustable DC power supply. The power supply is built using a transformator with multiple secondary windings of 14 V AC, 10 V AC, 7 V AC, and 4 V AC. For the project, the 21 V AC winding was selected and connected to a linear regulator circuit, which provides a controlled DC output voltage from 0 V to 25 V with a maximum current of 3 A. Additionally, the power supply is equipped with a digital voltmeter and ammeter, allowing real-time monitoring of the output voltage and current. This setup is ideal for electronics testing, prototyping, and lab experiments.
